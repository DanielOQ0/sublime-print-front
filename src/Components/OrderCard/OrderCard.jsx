...
export default function OrderCard() {
    return (    
    <div class="order-card max-w-sm p-6 bg-white rounded-lg shadow ">
        ...
        <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">Order #: 123234</p>
        <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">Status: Pending</p>
