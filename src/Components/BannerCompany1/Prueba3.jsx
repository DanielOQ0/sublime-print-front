...
export default function Prueba3() {
  ...
  <div className='company-g'>
          ...
          <div class="banner-company">
            <h2 className='title-banner-company'>Sublime Prints</h2>
    ...
    <div class="container-company-2">
      <img src="https://www.altamirahrm.com/wp-content/uploads/2021/09/Sistemi-di-timbratura.jpg" className='image-banner-2'/>
        <div className='text-3'>
          <h4 className='title-3'>FROM HOME IS EASIER</h4>
          <p className='text' >
            ...
            We send you emails, sms and alerts so you don't forget anything ;)
          </p>
        </div>   
    </div>
    ...
    <div class="container-company-2">
        ...
        <div className='text-3'>
          <h4 className='title-3'>FREE SHIPPING AND RETURNS</h4>
          <p className='text' >
        ...
        <img src="https://thelogisticsworld.com/wp-content/uploads/2022/07/Repartidor-con-cajas-de-carton-e1662733205119.jpg" className='image-banner-2 '/>   
    </div>
